...
class ParserTest < Minitest::Test
  def test_lab_results_txt
    ...
    assert_equal 'NTE', parser.comments_mapped_results[1].prefix
    assert_equal '1', parser.comments_mapped_results[1].laboratory_test_result_id
    assert_equal 'Comment for C100 result', parser.comments_mapped_results[1].comment
    ...
    assert_equal '2', parser.comments_mapped_results[3].laboratory_test_result_id
    assert_equal 'Comment for C200 result', parser.comments_mapped_results[3].comment
    ...
    assert_equal 'NTE', parser.comments_mapped_results[8].prefix
    assert_equal '4', parser.comments_mapped_results[8].laboratory_test_result_id
    assert_equal 'Comment 2 for ++ result', parser.comments_mapped_results[8].comment
  end
